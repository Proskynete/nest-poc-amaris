...
## Contexto del Proyecto: @eduadoalvarez/resume

- **Arquitectura**: Clean Architecture con NestJS + Fastify
- **Patrón**: API → Service → Repository → Database
- **Base de datos**: PostgreSQL con TypeORM
- **Testing**: Pirámide de testing (unitarios → integración → E2E) + prueba de cargas
- **Documentación**: Documentación técnica clara y detallada
